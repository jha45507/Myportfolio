...
function HomePage() {
  return (
    <>
      <div className='container grid md:grid-cols-2 md:h-[89vh] md:flex-row py-10 m-auto min-w-[320px]'>

        <div className='center w-full '>

          <div className=' md:scale-100 sm:scale-100 scale-90 xl:scale-100 '>
        ...
        <div className=' w-3/4 center md:w-[55%] m-auto my-10 '>
